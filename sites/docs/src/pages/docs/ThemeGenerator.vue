...
import { type Theme } from '@code-coaching/vuetiful/dist/types/utils/theme/themes';
  ...
  <div class="flex flex-col max-w-5xl p-4">
    ...
    <transition name="slide-bottom-300">
      <div v-if="isThemeGenerated">
        ...
        <section class="gap-4 p-4 section card">
          <h3 class="mb-0 h3" data-toc-ignore>Fonts</h3>
          ...
          <h3 class="mb-0 h3" data-toc-ignore>Text Color</h3>
          <div class="flex flex-wrap gap-4 mb-4">
          ...
          <h3 class="col-span-2 mb-0 h3" data-toc-ignore>Border Radius</h3>
          <div class="flex flex-wrap gap-4 mb-4">
            <label class="flex-1 label">
              <span>Base</span>
              <div class="input-group input-group-divider h-[50px] pl-4 bg-surface-50-900-token">
          ...
          <h3 class="mb-0 h3" data-toc-ignore>Border Size</h3>
          <div class="flex flex-wrap gap-4 mb-4">
            <label class="flex-1 label">
              <span>Base</span>
              <div class="input-group input-group-divider h-[50px] pl-4 bg-surface-50-900-token">
