...
const vuetiful = {
  ...
  properties: {
    ...
    '--color-primary-50': 'rgb(255, 204, 255)',
    '--color-primary-100': 'rgb(251, 178, 235)',
    '--color-primary-200': 'rgb(247, 151, 214)',
    '--color-primary-300': 'rgb(244, 125, 194)',
    '--color-primary-400': 'rgb(240, 98, 173)',
    '--color-primary-500': 'rgb(236, 72, 153)',
    '--color-primary-600': 'rgb(209, 58, 131)',
    '--color-primary-700': 'rgb(182, 43, 109)',
    '--color-primary-800': 'rgb(156, 29, 88)',
    '--color-primary-900': 'rgb(129, 14, 66)',
    '--color-primary-950': 'rgb(102, 0, 44)',
    ...
    '--color-secondary-50': 'rgb(185, 255, 255)',
    '--color-secondary-100': 'rgb(149, 240, 246)',
    '--color-secondary-200': 'rgb(113, 226, 238)',
    '--color-secondary-300': 'rgb(78, 211, 229)',
    '--color-secondary-400': 'rgb(42, 197, 221)',
    '--color-secondary-500': 'rgb(6, 182, 212)',
    '--color-secondary-600': 'rgb(5, 159, 188)',
    '--color-secondary-700': 'rgb(4, 136, 165)',
    '--color-secondary-800': 'rgb(2, 113, 141)',
    '--color-secondary-900': 'rgb(1, 90, 118)',
    '--color-secondary-950': 'rgb(0, 67, 94)',
    ...
    '--color-tertiary-50': 'rgb(180, 255, 255)',
    '--color-tertiary-100': 'rgb(148, 241, 237)',
    '--color-tertiary-200': 'rgb(116, 227, 219)',
    '--color-tertiary-300': 'rgb(84, 212, 202)',
    '--color-tertiary-400': 'rgb(52, 198, 184)',
    '--color-tertiary-500': 'rgb(20, 184, 166)',
    '--color-tertiary-600': 'rgb(16, 161, 144)',
    '--color-tertiary-700': 'rgb(12, 137, 122)',
    '--color-tertiary-800': 'rgb(8, 114, 99)',
    '--color-tertiary-900': 'rgb(4, 90, 77)',
    '--color-tertiary-950': 'rgb(0, 67, 55)',
    ...
    '--color-success-50': 'rgb(255, 255, 161)',
    '--color-success-100': 'rgb(230, 245, 133)',
    '--color-success-200': 'rgb(206, 235, 105)',
    '--color-success-300': 'rgb(181, 224, 78)',
    '--color-success-400': 'rgb(157, 214, 50)',
    '--color-success-500': 'rgb(132, 204, 22)',
    '--color-success-600': 'rgb(106, 180, 18)',
    '--color-success-700': 'rgb(79, 156, 13)',
    '--color-success-800': 'rgb(53, 133, 9)',
    '--color-success-900': 'rgb(26, 109, 4)',
    '--color-success-950': 'rgb(0, 85, 0)',
    ...
    '--color-warning-50': 'rgb(255, 255, 155)',
    '--color-warning-100': 'rgb(251, 240, 126)',
    '--color-warning-200': 'rgb(247, 225, 96)',
    '--color-warning-300': 'rgb(242, 209, 67)',
    '--color-warning-400': 'rgb(238, 194, 37)',
    '--color-warning-500': 'rgb(234, 179, 8)',
    '--color-warning-600': 'rgb(208, 156, 6)',
    '--color-warning-700': 'rgb(182, 134, 5)',
    '--color-warning-800': 'rgb(155, 111, 3)',
    '--color-warning-900': 'rgb(129, 89, 2)',
    '--color-warning-950': 'rgb(103, 66, 0)',
    ...
    '--color-error-50': 'rgb(255, 199, 183)',
    '--color-error-100': 'rgb(252, 173, 160)',
    '--color-error-200': 'rgb(249, 147, 137)',
    '--color-error-300': 'rgb(245, 120, 114)',
    '--color-error-400': 'rgb(242, 94, 91)',
    '--color-error-500': 'rgb(239, 68, 68)',
    '--color-error-600': 'rgb(211, 54, 54)',
    '--color-error-700': 'rgb(183, 41, 41)',
    '--color-error-800': 'rgb(156, 27, 27)',
    '--color-error-900': 'rgb(128, 14, 14)',
    '--color-error-950': 'rgb(100, 0, 0)',
    ...
    '--color-surface-50': 'rgb(237, 222, 255)',
    '--color-surface-100': 'rgb(209, 198, 252)',
    '--color-surface-200': 'rgb(182, 174, 249)',
    '--color-surface-300': 'rgb(154, 150, 247)',
    '--color-surface-400': 'rgb(127, 126, 244)',
    '--color-surface-500': 'rgb(99, 102, 241)',
    '--color-surface-600': 'rgb(79, 83, 216)',
    '--color-surface-700': 'rgb(59, 63, 191)',
    '--color-surface-800': 'rgb(40, 44, 166)',
    '--color-surface-900': 'rgb(20, 24, 141)',
    '--color-surface-950': 'rgb(0, 5, 116)',
...
[data-theme='vuetiful'] {
  ...
  .kbd {
    ...
    color: var(--color-surface-contrast-600);
  }
...
.dark [data-theme='vuetiful'] {
  ...
  .kbd {
    ...
    color: var(--color-surface-contrast-400);
  }

  .code {
    background-color: var(--color-surface-300);
    color: var(--color-surface-contrast-300);
  }
