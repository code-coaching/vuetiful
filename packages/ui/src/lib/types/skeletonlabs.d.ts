declare module '@skeletonlabs/skeleton/themes' {
  export const catppuccin: any;
  export const cerberus: any;
  declare const cerberus: {
    name: string;
    properties: {
  ...
  export { Theme, ThemeProperties, catppuccin, cerberus, pine, rose };
}
